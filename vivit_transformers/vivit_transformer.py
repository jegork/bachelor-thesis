from transformers import ViTModel, PreTrainedModel, PretrainedConfig
...
class ViViTForImageClassification(ViViTPreTrainedModel):
    def __init__(self, config):
        super(ViViTForImageClassification, self).__init__(config)
